...
export default function HelpCenterPage() {
  ...
  const faqData: FAQItem[] = [
    // 企业注册相关
    {
      ...
      answer: language === 'zh' 
        ? '企业注册需要准备：营业执照扫描件、参赛承诺书、商业计划书（中英双语版本）、演示文稿（中英双语版本）、企业简介（500字以内，中英双语）、项目简介（500字以内，中英双语）等。'
        : 'Enterprise registration requires: business license scan, commitment letter, business plan (bilingual version), presentation (bilingual version), enterprise overview (within 500 words, bilingual), project brief (within 500 words, bilingual), etc.',
      category: 'enterprise'
    },
    {
      id: 'enterprise-2',
    ...
    // 团队注册相关
    {
      ...
      answer: language === 'zh' 
        ? '团队注册需要准备：参赛承诺书、项目技术可行性分析（中英双语版本）、演示文稿（中英双语版本）、项目简介（500字以内，中英双语）、核心成员身份证或护照扫描件等。'
        : 'Team registration requires: commitment letter, technical feasibility analysis (bilingual version), presentation (bilingual version), project brief (within 500 words, bilingual), core members\' ID or passport scans, etc.',
      category: 'team'
    },
    {
      id: 'team-2',
